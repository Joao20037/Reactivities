...
import { loginSchema, type LogingSchema } from "../../lib/schemas/LoginSchema";
...
export default function LoginForm() {
    ...
    const {control, handleSubmit, formState: {isValid, isSubmitting}} = useForm<LogingSchema>({
        mode: 'onTouched',
        resolver: zodResolver(loginSchema)
    });

    const onSubmit = async (data: LogingSchema) => {
