...
public class CommentHub(IMediator mediator) : Hub
{
    ...
    public override async Task OnConnectedAsync()
    {
        ...
        if (string.IsNullOrEmpty(activityId)) throw new Exception("No activity with this id");

        // overriding all complains about activityId being a possible null because of the verification above
